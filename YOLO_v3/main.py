...
# 请先进行数据预处理: python data_preprocess.py


def parse_args():
    parser = ArgumentParser(
        description="Implementation of YOLO v3 with Paddlepaddle 2.0!")
    parser.add_argument('-v',
                        '--val_data',
                        type=str,
                        default='../data/coco/5k.txt',
                        help='validation dataset.')
    parser.add_argument('-t',
                        '--train_data',
                        type=str,
                        default='../data/coco/trainvalno5k.txt',
...
def main():
    ...
    train_dataset = cocoDetectionDataset(root=train_dataDir,
